...
class PagerPage extends StatefulWidget {
  ...
  List<ImageUnsplash> _images;
  Map<String, ImageUnsplash> _favorites;
  int _initialPage;

  PagerPage(this._images, this._favorites, this._initialPage);

  @override
  _PagerPageState createState() =>
      _PagerPageState(_images, _favorites, _initialPage);
}
...
class _PagerPageState extends State<PagerPage> {
  ...
  _PagerPageState(this._images, this._favorites, this._initialPage);
